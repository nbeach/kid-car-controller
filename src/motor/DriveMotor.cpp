...
void DriveMotor::setSpeed(int speed) {
  ...
  int cappedReverseSpeedLimit =
      speedLimit < reverseSpeedLimit ? speedLimit : reverseSpeedLimit;
...
bool DriveMotor::isAboveLimit(int speed) { return abs(speed) > speedLimit; }
