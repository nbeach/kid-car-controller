...
#include "src/log/AbstractLogger.h"
#include "src/log/SerialLogger.h"
...
void setup() {
  ...
  //Drive Motor
  auto motors = new AbstractMotor*[DRIVE_MOTOR_COUNT] {
  ...
  //Throttle
  auto controllerThrottle = new WirelessControllerThrottle(controller, PS2_JOYSTICK_RIGHT_Y_AXIS);
  auto pedal = new ThrottlePedal(
